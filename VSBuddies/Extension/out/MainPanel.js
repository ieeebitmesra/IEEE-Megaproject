...
class MainPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(MainPanel.viewType, "VSBuddies", column || vscode.ViewColumn.One, {
    ...
    _getHtmlForWebview(webview) {
        ...
        const cssUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "out", "compiled/MainPanel.css"));
